...
export const InlineCitationPill: React.FC<{
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="inline-flex items-baseline gap-0.5 ml-0.5 align-super text-micro 3xl:text-xs 4xl:text-sm font-medium leading-none text-text-muted hover:text-brand-500 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus focus-visible:ring-offset-1 rounded-sm transition-colors"
      title={title}
